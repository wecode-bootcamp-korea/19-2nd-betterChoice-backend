...
from reservations.models import Status, Reservation
...
class ReservationTestCase(TestCase):
    ...
    def test_reservationview_post_no_information(self):
        ...
        self.assertEqual(response.json(),{'MESSAGE' : 'INVALID_INFORMATION'})
    ...
    def test_reservationview_post_no_remain_room(self):
        ...
        self.assertEqual(response.status_code, 404)
        self.assertEqual(response.json(), {'MESSAGE' : 'INVALID_REMAIN'})
